...
function guardarCategoria(event){
    ...
    API.post(formData,"categoria/save").then(
        data=>{
...
function editarCategoria(id) {
    ...
    panelDatos.classList.add("d-none");
    panelForm.classList.remove("d-none");
    API.get("categoria/getOneCategoria?id="+id).then(
        data=>{
            if (data.success) {
    ...
    Swal.fire({
        ...
        resultado=>{
            ...
            if (resultado.isConfirmed){
                API.get("categoria/deleteCategoria?id="+id).then(
                    data=>{
                        if (data.success) {
                            cancelarCategoria();
                            Swal.fire({
