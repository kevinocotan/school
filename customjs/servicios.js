...
function guardarServicio(event){
    ...
    API.post(formData,"servicios/save").then(
        data=>{
...
function editarServicio(id) {
    ...
    panelDatos.classList.add("d-none");
    panelForm.classList.remove("d-none");
    API.get("servicios/getOneServicio?id="+id).then(
        data=>{
            if (data.success) {
    ...
    Swal.fire({
        ...
        resultado=>{
            ...
            if (resultado.isConfirmed){
                API.get("servicios/deleteServicio?id="+id).then(
                    data=>{
                        if (data.success) {
                            cancelarServicio();
                            Swal.fire({
