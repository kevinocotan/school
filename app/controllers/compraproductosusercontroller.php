<?php
include_once "app/models/compraproductosuser.php";
class CompraProductosUserController extends Controller {
    private $compraproducto;
    public function __construct($parametro) {
        $this->compraproducto=new CompraProductosUser();
        parent::__construct("compraproductosuser",$parametro,true);
    }
