<?php
include_once "app/models/subcategoriauser.php";

class SubcategoriaUserController extends Controller {
    private $subcategoria;
    public function __construct($parametro) {
        $this->subcategoria=new SubcategoriaUser();
        parent::__construct("subcategoriauser",$parametro,true);
    }
