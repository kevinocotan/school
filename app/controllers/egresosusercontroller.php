<?php
include_once "app/models/egresosuser.php";
class EgresosUserController extends Controller {
    private $egreso;
    public function __construct($parametro) {
        $this->egreso=new EgresosUser();
        parent::__construct("egresosuser",$parametro,true);
    }
