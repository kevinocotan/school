...
<head>
    ...
    <title>Reporte de Egresos - Iveth´s Beauty Salón Spa & Nails</title>
</head>
<body>
    <div class="container">
        ...
        <section id="contenido">
            <form class="row gy-2 gx-3 align-items-center mt-3 mb-3">
                ...
                <div class="col-auto d-flex filtrodia">
                    ...
                    <select name="id_egreso" id="id_egreso" class="form-select">
                    </select>
                </div>
    ...
    <script src="<?php echo URL;?>public_html/customjs/reporteegresos.js"></script>
</body>
</html>