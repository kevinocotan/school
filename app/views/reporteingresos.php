...
<head>
    ...
    <title>Reporte de Ingresos - MyControl School</title>
</head>
<body>
    <div class="container">
        ...
        <section id="contenido">
            <form class="row gy-2 gx-3 align-items-center mt-3 mb-3">
                ...
                <div class="col-auto d-flex">
                    <label class="col-form-label mx-3" for="autoSizingInput">Cliente</label>
                    <select name="id_cliente" id="id_cliente" class="form-select">

                    </select>
                </div>
                <div class="col-auto d-flex">
                    <label class="col-form-label mx-3" for="autoSizingInput">Pago</label>
