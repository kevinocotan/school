...
<head>
    ...
    <title>Subcategoría - Iveth´s Beauty Salón Spa & Nails</title>
</head>
<body>
    <div class="container">
            ...
            <div id="contentForm" class="mt-3 d-none">
                ...
                <form id="formSubcategoria">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="subcategoria" id="subcategoria" rows="3" class="form-control">
                            <input type="hidden" name="id_subcategoria" id="id_subcategoria" value="0">
                        </div>
                    </div>         
    ...
    <script src="<?php echo URL;?>public_html/customjs/subcategoriauser.js"></script>
</body>
</html>